	...
	<header id="masthead" class="site-header">
		...
		<div class="second-row">
			...
			<div class="nav-options">
				<svg class="search-box-trigger" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<svg class="shopcart-container" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
